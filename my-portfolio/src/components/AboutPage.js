...
const AboutPage = () =>{
    return(
        <AboutDiv>
            ...
            <p><strong>I</strong> was born across the street (or rather, across the parking lot) from Milan Puskar Stadium in Morgantown, WV. Don't worry, I will not go year by year of my life story. I simply mean to set the framework that I was born for football.</p>
